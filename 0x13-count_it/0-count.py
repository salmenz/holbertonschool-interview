...
def count_words(subreddit, word_list, hot_list=[], init=0, after=""):
    """Recursive function that queries the Reddit API"""

    URL = f"https://www.reddit.com/r/{subreddit}/hot.json"
    agent = {"User-Agent": "linux:1:v2.1 (by /u/heimer_r)"}
    parm = {"limit": "100", "after": after}
    hot = requests.get(URL, headers=agent, params=parm, allow_redirects=False)
